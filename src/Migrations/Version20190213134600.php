 ...
 */
final class Version20190213134600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE userlog (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , password VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4E107E60E7927C74 ON userlog (email)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__opinion AS SELECT id, recipe_id, user_id, commentary, note FROM opinion');
        ...
        $this->addSql('INSERT INTO opinion (id, recipe_id, user_id, commentary, note) SELECT id, recipe_id, user_id, commentary, note FROM __temp__opinion');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__opinion AS SELECT id, recipe_id, user_id, commentary, note FROM opinion');
        $this->addSql('DROP TABLE opinion');
        $this->addSql('CREATE TABLE opinion (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, recipe_id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, commentary VARCHAR(255) NOT NULL, note SMALLINT NOT NULL)');
        $this->addSql('INSERT INTO opinion (id, recipe_id, user_id, commentary, note) SELECT id, recipe_id, user_id, commentary, note FROM __temp__opinion');
        $this->addSql('DROP TABLE __temp__opinion');
        $this->addSql('CREATE INDEX IDX_AB02B02759D8A214 ON opinion (recipe_id)');
        $this->addSql('CREATE INDEX IDX_AB02B027A76ED395 ON opinion (user_id)');
